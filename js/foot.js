$(document).ready(function(e){
    $('.copyright').html('<i class="far fa-clock" />2023</i> <i class="far fa-cloud" /></i> By 武云耕');
})
​
$(document).ready(function(e){
    show_date_time();
...
$('.framework-info').html('云上小屋已漂流<span id="span_dt_dt" style="color: #fff;"></span>');
window.setTimeout("show_date_time()", 1000);
BirthDay=new Date("1/6/2023 0:0:0");
today=new Date();
